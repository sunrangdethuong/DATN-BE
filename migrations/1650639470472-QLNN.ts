...
export class QLNN1650639470472 implements MigrationInterface {
    name = 'QLNN1650639470472'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`don_dat_phongs\` (\`id\` int NOT NULL AUTO_INCREMENT, \`ten_khach_hang\` varchar(255) NOT NULL, \`so_cmt\` int NOT NULL, \`check_in\` date NOT NULL, \`check_out\` date NOT NULL, \`cost\` int NOT NULL, \`status\` tinyint NOT NULL DEFAULT '0', \`note\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
